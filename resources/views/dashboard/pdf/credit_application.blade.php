...
<table style="font-family: Helvetica;">
  ...
  <tr>
    <td style="white-space: nowrap;" colspan="2">Length of Time at Current Address (Years): {{ $app->years_at_address }}, {{ $app->owner_status }} Monthly Payment: {{ $user->budget->mortgage }}</td> 
  </tr>
  <tr>
